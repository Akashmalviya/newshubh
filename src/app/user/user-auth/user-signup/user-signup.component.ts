...
export class UserSignupComponent implements OnInit {
  ...
  ngOnInit() {
    this.registerForm = this.fb.group({
      ...
      companyPhone: ['', [Validators.required,Validators.minLength(10), Validators.maxLength(11)]],
      ...
      this.registerForm2 = this.fb.group({
        firstContactPerson: ['', [Validators.required , Validators.pattern('[A-Za-z\s]*')]],
      ...
      firstContactPhone: ['', [Validators.required,Validators.minLength(10), Validators.maxLength(11), Validators.pattern('^((\\+91-?)|0)?[0-9]{10}$')]],
      secondContactPerson: ['', [Validators.required , Validators.pattern('[A-Za-z\s]*')]],
      ...
      secondContactPhone: ['', [Validators.required,Validators.minLength(10), Validators.maxLength(11), Validators.pattern('^((\\+91-?)|0)?[0-9]{10}$')]],
  ...
  email(registerForm: FormGroup) {
    ...
    return email.toLowerCase() === confirmEmail.toLowerCase() ? null  : { emailNotMatch: true };
  }
    ...
    if(this.registerForm && this.registerForm2){
      ...
      this.userservice.register(formJoin).subscribe(res => {
        ...
        if(this.response.status === '1'){
          ...
          this.alert.success('Thanks for signup, we have sent email for account verification. Please verify to access the account.')
