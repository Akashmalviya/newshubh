...
export class NewOrderComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.placeOrder = this.fb.group({
      ...
      picupContactPersonName: ['', Validators.required],
      picupBusinessMainNumber: ['', Validators.required],
      picupMobileNumber: ['', [Validators.required,Validators.maxLength(12),Validators.minLength(10)]],
